...
처음으로 tvOS는 개발자에 게 Apple TV 플랫폼을 열어서 iTunes 앱 스토어를 사용 하 여 iOS 용 앱을 작성 하 고 해제 하는 환경과 유사한 프로세스에서 다양 한 몰입 형 앱을 만들고 Apple TV의 기본 제공 앱 스토어를 통해 릴리스 합니다.
