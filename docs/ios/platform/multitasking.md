...
![분할 화면 예](multitasking-images/about02-sml.png) ![그림에 그림 예제](multitasking-images/about03-sml.png)
...
[![패널 위로 이동](multitasking-images/about01.png)](multitasking-images/about01.png#lightbox)
...
[![분할 뷰](multitasking-images/about02.png)](multitasking-images/about02.png#lightbox)
...
[![그림 부동 창의 예제 그림](multitasking-images/about03.png)](multitasking-images/about03.png#lightbox)
...
[![화면 크기 및 방향 고려 사항](multitasking-images/sizeclasses01.png)](multitasking-images/sizeclasses01.png#lightbox)
...
[![장치가 가로 인 경우에만 표시 되는 목록](multitasking-images/sizeclasses04.png)](multitasking-images/sizeclasses04.png#lightbox)
...
[![앱 전환기](multitasking-images/keyboard01.png)](multitasking-images/keyboard01.png#lightbox)

IOS 9 앱에 바로 **가기 키가** 포함 되어 있는 경우 사용자는 **명령**, **옵션** 또는 키를 사용 하 여 팝업에 표시할 수 있습니다.

[![바로 가기 키 팝업](multitasking-images/keyboard02.png)](multitasking-images/keyboard02.png#lightbox)
...
[![멀티태스킹 옵트아웃](multitasking-images/fullscreen01.png)](multitasking-images/fullscreen01.png#lightbox)
