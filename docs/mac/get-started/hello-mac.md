...
[![실행 중인 Hello, Mac 앱의 예제](hello-mac-images/run02-sml.png)](hello-mac-images/run02.png#lightbox)
...
1. Mac용 Visual Studio 시작:
    ...
    [![Mac용 Visual Studio 기본 인터페이스](hello-mac-images/setup01-sml.png)](hello-mac-images/setup01.png#lightbox)

2. **새 프로젝트...** 단추를 클릭하여 **새 프로젝트** 대화 상자를 연 이후에 **Mac** > **앱** > **Cocoa 앱**을 선택하고 **다음** 단추를 클릭합니다.

    [![Cocoa 앱 선택](hello-mac-images/setup02-sml.png)](hello-mac-images/setup02.png#lightbox)

3. **앱 이름**으로 `Hello_Mac`을 입력하고, 나머지는 기본값을 유지합니다. **다음**을 클릭합니다.

    [![앱 이름 설정](hello-mac-images/setup03-sml.png)](hello-mac-images/setup03.png#lightbox)

4. 컴퓨터에서 새 프로젝트의 위치를 확인합니다.

    [![새 솔루션 세부 정보 확인](hello-mac-images/setup04-sml.png)](hello-mac-images/setup04.png#lightbox)

5. **만들기** 단추를 클릭합니다.

Mac용 visual Studio가 새 Xamarin.Mac 앱을 만들고 앱의 솔루션에 추가되는 기본 파일을 표시합니다.

[![새 솔루션 기본 보기](hello-mac-images/project01-sml.png)](hello-mac-images/project01.png#lightbox)
...
[![Mac용 Visual Studio plist 편집기](hello-mac-images/infoplist01.png)](hello-mac-images/infoplist01.png#lightbox)
...
[![Mac용 Visual Studio 자격 편집기](hello-mac-images/entitlements01.png)](hello-mac-images/entitlements01.png#lightbox)
...
[![솔루션 탐색기의 Main.storyboard 파일](hello-mac-images/xcode01.png)](hello-mac-images/xcode01.png#lightbox)

그러면 Xcode가 시작되고 다음 스크린샷과 비슷하게 표시됩니다.

[![기본 Xcode Interface Builder 보기](hello-mac-images/xcode02.png)](hello-mac-images/xcode02.png#lightbox)
...
[![Xcode에서 Interface Builder의 다양한 섹션](hello-mac-images/xcode03.png)](hello-mac-images/xcode03.png#lightbox)
...
[![속성 검사기](hello-mac-images/xcode04.png)](hello-mac-images/xcode04.png#lightbox)
...
[![모든 검사기 개요](hello-mac-images/xcode05.png)](hello-mac-images/xcode05.png#lightbox)
...
[![Xcode 라이브러리 검사기](hello-mac-images/xcode06.png)](hello-mac-images/xcode06.png#lightbox)
...
1. Xcode의 **라이브러리 섹션**에서 **누름 단추**를 끕니다.
    ...
    [![라이브러리 검사기에서 NSButton 선택](hello-mac-images/xcode07.png)](hello-mac-images/xcode07.png#lightbox)

2. **인터페이스 편집기**에서 **보기**(**창 컨트롤러** 아래)에 단추를 놓습니다.

    [![인터페이스 디자인에 단추 추가](hello-mac-images/xcode08.png)](hello-mac-images/xcode08.png#lightbox)
...
4. **라이브러리 섹션**에서 **레이블**을 끕니다.
    ...
    [![라이브러리 검사기에서 레이블 선택](hello-mac-images/xcode10.png)](hello-mac-images/xcode10.png#lightbox)

5. **인터페이스 편집기**에서 단추 옆에 있는 **창**에 레이블을 놓습니다.

    [![인터페이스 디자인에 레이블 추가](hello-mac-images/xcode11.png)](hello-mac-images/xcode11.png#lightbox)

6. 레이블의 오른쪽 핸들을 잡고 창의 가장자리 근처까지 끕니다.

    [![레이블 크기 조정](hello-mac-images/xcode12.png)](hello-mac-images/xcode12.png#lightbox)

7. **인터페이스 편집기**에서 방금 추가한 단추를 선택하고 창의 아래쪽에서 **제약 조건 편집기** 아이콘을 클릭합니다.

    [![단추에 제약 조건 추가](hello-mac-images/xcode13.png)](hello-mac-images/xcode13.png#lightbox)
...
11. 레이블을 선택하고 **제약 조건 편집기** 아이콘을 다시 클릭합니다.
    ...
    [![레이블에 제약 조건 추가](hello-mac-images/xcode14.png)](hello-mac-images/xcode14.png#lightbox)

12. **제약 조건 편집기**의 위쪽, 오른쪽 및 왼쪽에서 **빨간색 I-빔**을 클릭하면 실행 중인 애플리케이션에서 창 크기를 조정할 때 레이블의 위치는 지정된 X 및 Y로 고정되고 크기는 확장 및 축소됩니다.
...
[![인터페이스 계층 구조에서 요소 선택](hello-mac-images/xcode15.png)](hello-mac-images/xcode15.png#lightbox)
...
[![Xcode에서 원본 보기](hello-mac-images/xcode16-sml.png)](hello-mac-images/xcode16.png#lightbox)
...
1. 화면의 오른쪽 맨 위 모서리에 있는 Xcode에서 **이중 원** 단추를 클릭하여 **도우미 편집기**를 엽니다.
    ...
    [![도우미 편집기 표시](hello-mac-images/outlet01.png)](hello-mac-images/outlet01.png#lightbox)
...
4. **코드 편집기** 위쪽에서 **자동 링크**를 클릭하고 `ViewController.h` 파일을 선택합니다.
    ...
    [![올바른 파일 선택](hello-mac-images/outlet02.png)](hello-mac-images/outlet02.png#lightbox)

5. Xcode가 이제 올바른 파일을 선택했습니다.

    [![ViewController.h 파일 보기](hello-mac-images/outlet03.png)](hello-mac-images/outlet03.png#lightbox)
...
7. **인터페이스 편집기**에서 키보드의 **Control** 키를 누른 채로 위에서 만든 레이블을 클릭하여 `@interface ViewController : NSViewController {}` 코드 바로 아래에 있는 코드 편집기 위로 끕니다.
    ...
    [![끌어서 아웃렛 만들기](hello-mac-images/outlet04.png)](hello-mac-images/outlet04.png#lightbox)

8. 대화 상자가 표시됩니다. **연결**은 **출선**으로 두고 **이름**으로 `ClickedLabel`을 입력합니다.

    [![아웃렛 정의](hello-mac-images/outlet05.png)](hello-mac-images/outlet05.png#lightbox)

9. **연결** 단추를 클릭하여 **출선**을 만듭니다.

    [![최종 아웃렛 보기](hello-mac-images/outlet06.png)](hello-mac-images/outlet06.png#lightbox)
...
2. **인터페이스 편집기**에서 키보드의 **Control** 키를 누른 채로 위에서 만든 단추를 클릭하여 `@property (assign) IBOutlet NSTextField *ClickedLabel;` 코드 바로 아래에 있는 코드 편집기 위로 끕니다.
    ...
    [![끌어서 작업 만들기](hello-mac-images/action01.png)](hello-mac-images/action01.png#lightbox)

3. **연결** 형식을 **작업**으로 변경합니다.

    [![작업 정의](hello-mac-images/action02.png)](hello-mac-images/action02.png#lightbox)

4. **이름**으로 `ClickedButton`을 입력합니다.

    [![새 작업의 이름 지정](hello-mac-images/action03.png)](hello-mac-images/action03.png#lightbox)

5. **연결** 단추를 클릭하여 **작업**을 만듭니다.

    [![최종 작업 보기](hello-mac-images/action04.png)](hello-mac-images/action04.png#lightbox)
...
[![Xcode와 변경 내용 동기화](hello-mac-images/sync01-sml.png)](hello-mac-images/sync01.png#lightbox)
...
[![Mac용 Visual Studio에서 ViewController.cs 파일 보기](hello-mac-images/code01-sml.png)](hello-mac-images/code01.png#lightbox)
...
[![디버그 빌드 선택](hello-mac-images/run01-sml.png)](hello-mac-images/run01.png#lightbox)
...
[![애플리케이션 실행](hello-mac-images/run02-sml.png)](hello-mac-images/run02.png#lightbox)

단추를 몇 번 클릭하면 그 횟수에 따라 레이블이 업데이트됩니다.

[![단추 클릭 결과 표시](hello-mac-images/run03-sml.png)](hello-mac-images/run03.png#lightbox)
