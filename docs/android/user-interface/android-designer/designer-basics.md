...
디자이너는 레이아웃을 만들 때 자동으로 시작 되거나 기존 레이아웃 파일을 두 번 클릭 하 여 시작할 수 있습니다. 예를 들어 **리소스 > 레이아웃** 폴더에서 **activity_main. axml** 을 두 번 클릭 하면 다음 스크린샷에 표시 된 것 처럼 디자이너가 로드 됩니다.
...
마찬가지로 **솔루션 탐색기** 의 **레이아웃** 폴더를 마우스 오른쪽 단추로 클릭 하 고 **> 새 항목 추가 ... > Android 레이아웃**을 선택 하 여 새 레이아웃을 추가할 수 있습니다.
...
- **소스 창** &ndash; **Design Surface**에 표시 된 디자인에 해당 하는 기본 XML 원본에 대 한 뷰를 제공 합니다.

- **디자이너 도구 모음** &ndash; 선택기 목록 ( **장치**, **버전**, **테마**, 레이아웃 구성 및 작업 모음 설정)을 표시 합니다. **디자이너 도구 모음** 에는 테마 편집기를 시작 하 고 재질 디자인 그리드를 사용 하기 위한 아이콘도 포함 되어 있습니다.

- **도구 상자** &ndash; **Design Surface**로 끌어서 놓을 수 있는 위젯 및 레이아웃 목록을 제공 합니다.
...
- **구성 선택기** &ndash; *세로* 또는 *가로*와 같은 장치 구성을 선택 합니다.

- **리소스 한정자 옵션** &ndash; *언어*, *UI 모드*, *야간 모드*및 *둥근 화면* 옵션을 선택할 드롭다운 메뉴를 표시 하는 대화 상자를 엽니다.

- **작업 모음 설정** &ndash; 레이아웃에 대 한 작업 모음 설정을 구성 합니다.

- **테마 편집기** &ndash; *테마 편집기*를 엽니다 .이 편집기를 사용 하면 선택한 테마의 요소를 사용자 지정할 수 있습니다.

- **재질 디자인 그리드** &ndash; *재질 디자인 그리드*를 사용 하거나 사용 하지 않도록 설정 합니다. 재질 디자인 그리드 옆에 있는 드롭다운 메뉴 항목은 표를 사용자 지정할 수 있는 대화 상자를 엽니다.

이러한 각 기능은 다음 항목에서 자세히 설명 합니다.

- [리소스 한정자 및 시각화 옵션](~/android/user-interface/android-designer/resource-qualifiers.md) 은 **장치 선택기**,   **Android 버전 선택기**, **테마 선택기**, **구성 선택기**, **리소스 자격 옵션**및 **작업 모음 설정**에 대 한 자세한 정보를 제공 합니다.
...
이 예제에서를 마우스 오른쪽 단추로 클릭 하면 `TextView` 여러 가지 옵션을 제공 하는 상황에 맞는 메뉴가 열립니다.

- **LinearLayout** &ndash; 의 부모를 편집 하기 위한 하위 메뉴를 엽니다 `LinearLayout` `TextView` .

- 마우스 오른쪽 단추 클릭에 적용 되는 **삭제**, **복사**및 **잘라내기** &ndash; 작업 `TextView` 입니다.
...
- **컨테이너** &ndash; 강조 표시 확대 및 축소 하는 동안 쉽게 찾을 수 있도록   **Design Surface** 의 컨테이너를 강조 표시 합니다.

- **보통 크기** &ndash; 선택한 장치의 해상도에서 레이아웃이 어떻게 보이는지 확인할 수 있도록 픽셀의 레이아웃 픽셀을 렌더링 합니다.

- **창** &ndash; 에 맞춤 전체 레이아웃이 Design Surface 표시 되도록 확대/축소 수준을 설정 합니다.
...
- **디자인** &ndash; 이 맨 위 단추 **디자인**은 **디자인** 창을 선택 합니다. 이 단추를 클릭 하면 **도구 상자** 및 **속성** 창이 활성화 되 고 **텍스트 편집기 도구 모음이** 표시 되지 않습니다. **축소** 단추를 클릭 하면 (아래 참조) **소스** 창이 없으면 **디자인** 창이 단독으로 표시 됩니다.

- **창 바꾸기** &ndash; 이 단추 (반대 방향 양방향 화살표)는 **소스** 창이 왼쪽에 있고 **디자인** 창이 오른쪽에 오도록 **디자인** 창과 **소스** 창을 바꿉니다. 다시 클릭 하면 이러한 창이 원래 위치로 다시 바뀝니다.

- **원본** &ndash; 이 단추 (꺾쇠 괄호 두 개와 유사)는 **원본** 창을 선택 합니다. 이 단추를 클릭 하면 **도구 상자** 및 **속성** 창이 사용 하지 않도록 설정 되 고 **텍스트 편집기 도구 모음이** Visual Studio 위쪽에 표시 됩니다. **축소** 단추를 클릭할 때 (아래 참조) **원본** 단추를 클릭 하면 **디자인** 창 대신 **소스** 창이 표시 됩니다.

- **세로 분할** &ndash; 세로 막대와 유사 하 게이 단추를 클릭 하면 **디자인** 창과 **소스** 창이 나란히 표시 됩니다. 이는 기본 정렬입니다.

- **가로 분할** &ndash; 이 단추 (가로 막대와 유사)는 **소스** 창 위에 **디자인** 창을 표시 합니다. 창 **바꾸기** 를 클릭 하면 **디자인** 창 위에 **소스** 창이 추가 됩니다.

- **창 축소** &ndash; 이 단추 (오른쪽 꺾쇠 괄호 두 개와 유사)는 **디자인** 및 **소스의** 이중 창 표시를 이러한 창 중 하나의 단일 뷰로 "축소" 합니다.
...
긴 XML 파일로 작업할 때 쉽게 탐색할 수 있도록 **소스** 창에서 Visual Studio 스크롤 막대를 지원 합니다 (이전 스크린샷에서 오른쪽에 표시 됨). 스크롤 막대에 대 한 자세한 내용은 [스크롤 막대를 사용자 지정 하 여 코드를 추적 하는 방법](/visualstudio/ide/how-to-track-your-code-by-customizing-the-scrollbar)을 참조 하세요.

### <a name="autocompletion"></a>자동 완성

위젯에 대 한 특성의 이름을 입력 하기 시작할 때 <kbd>ctrl + SPACE</kbd> 를 눌러 가능한 완료 목록을 볼 수 있습니다. 예를 들어 다음 예제를 입력 한 후 `android:lay` <kbd>CTRL + SPACE</kbd>를 입력 하면 다음 목록이 표시 됩니다.
...
위젯의 새 특성을 입력 하 고 값을 할당 하기 시작 하면 트리거 문자를 입력 한 후 IntelliSense가 표시 되 고 해당 특성에 사용할 유효한 값 목록이 제공 됩니다. 예를 들어 다음 예제에서에 대 한 첫 번째 큰따옴표를 입력 한 후에는 `android:layout_width` 이 너비에 대해 유효한 선택 항목 목록을 제공 하는 자동 완성 선택기 팝업이 표시 됩니다.
...
일부 속성은 레이아웃 **. axml** 파일 이외의 파일에 정의 된 리소스를 참조할 수 있습니다. 이 형식의 가장 일반적인 사례는 `string` 및 `drawable` 리소스입니다. 그러나 값 및 차원과 같은 다른 리소스에도 참조를 사용할 수 있습니다 `Boolean` . 속성이 리소스 참조를 지 원하는 경우 속성에 대 한 텍스트 항목 옆에 찾아보기 아이콘 (사각형)이 표시 됩니다. 이 단추를 클릭 하면 리소스 선택 기가 열립니다.
...
이 목록에서 **속성** 창의 텍스트를 하드 코딩 하는 대신 해당 위젯에 사용할 텍스트 리소스를 선택할 수 있습니다. 다음 예제에서는의 속성에 대 한 리소스 선택기를 보여 줍니다 `Src` `ImageView` .
...
속성의 오른쪽에 있는 빈 사각형을 클릭 하면 `Src` **리소스 선택** 대화 상자가 열리고, 위에 표시 된 색에서 drawables에 이르는 리소스 목록이 표시 됩니다.

### <a name="boolean-property-references"></a>부울 속성 참조

*부울* 속성은 일반적으로 속성 창의 속성 옆에 있는 확인 표시로 선택 됩니다. `true` `false` 이 확인란을 선택 하거나 선택 취소 하 여 또는 값을 지정 하거나, 속성의 오른쪽에 있는 짙은 채워진 사각형을 클릭 하 여 속성 참조를 선택할 수 있습니다. 다음 예에서는 선택한와 연결 된 **모든 대문자로** 된 부울 속성 참조 텍스트를 클릭 하 여 텍스트를 모두 대문자로 변경 합니다 `TextView` .
...
일부 위젯의 텍스트 속성 (예: `Button` 및)은 `TextView` **Design Surface**에서 직접 편집할 수 있습니다. 위젯을 두 번 클릭 하면 아래와 같이 편집 모드로 전환 됩니다.

![Hello 문자열의 텍스트 리소스](designer-basics-images/vs/12-text-resource.png "텍스트 리소스")

새 텍스트 값을 입력 하거나 새 리소스 문자열을 입력할 수 있습니다. 다음 예제에서 `@string/hello` 리소스는 텍스트 (:)로 대체 됩니다 `CLICK THIS BUTTON` .

![텍스트를 새 리소스에 자동으로 연결 하려면 Shift + Enter](designer-basics-images/vs/13-shift-enter-resource.png)

이 변경 내용은 위젯의 속성에 저장 되며 `text` 리소스에 할당 된 값을 수정 하지 않습니다 `@string/hello` .
...
위젯을 처음 클릭 하면 여백 핸들이 표시 됩니다. 마우스를 핸들 중 하나로 이동 하면 디자이너에서 핸들이 변경 될 속성을 표시 합니다 (아래와 같이 속성의 경우 `layout_marginLeft` ).
...
앞에서 설명한 것 처럼 이미 선택 되어 있는 위젯을 클릭 하 여 크기 편집 모드로 전환할 수 있습니다. 삼각형 핸들을 클릭 하 여 표시 된 차원의 크기를로 설정 합니다 `wrap_content` .
...
크기 값이 **내용 줄 바꿈**으로 설정 된 경우 디자이너는 크기를로 변경 하기 위한 반대 방향을 가리키는 삼각형 핸들을 표시 합니다 `match_parent` .

![부모 핸들 일치](designer-basics-images/vs/18-match-parent.png)

부모 핸들 **일치** 를 클릭 하면 해당 차원의 크기가 부모 위젯에 같도록 복원 됩니다.

또한 위의 스크린샷에 표시 된 것 처럼 원형 크기 조정 핸들을 끌어 위젯의 크기를 임의 값으로 조정할 수 있습니다 `dp` . 이렇게 하면 해당 차원에 대 한 **콘텐츠 래핑** 및 **일치 부모** 핸들이 모두 표시 됩니다.

![원형 크기 조정 핸들](designer-basics-images/vs/19-resize-dp.png)

모든 컨테이너가 위젯의를 편집할 수 있는 것은 아닙니다 `Size` . 예를 들어,가 선택 된 상태에서 아래 스크린샷에는 `LinearLayout` 크기 조정 핸들이 표시 되지 않습니다.
...
- **도구 모음** &ndash; 선택기 목록 ( **장치**, **버전**, **테마**, 레이아웃 구성 및 작업 모음 설정)을 표시 합니다. 도구 모음에는 테마 편집기를 시작 하 고 재질 디자인 그리드를 사용 하기 위한 아이콘도 포함 되어 있습니다.
...
이 예제에서를 마우스 오른쪽 단추로 클릭 하면 `Button` 여러 가지 옵션을 제공 하는 상황에 맞는 메뉴가 열립니다.

- **LinearLayout** &ndash; 의 부모를 편집 하기 위한 하위 메뉴를 엽니다 `LinearLayout` `Button` .

- 마우스 오른쪽 단추 클릭에 적용 되는 **잘라내기**, **복사**및 **삭제** &ndash; 작업 `Button` 입니다.
...
- **컨테이너** &ndash; 강조 표시 확대 및 축소 하는 동안 쉽게 찾을 수 있도록 Design Surface의 컨테이너를 강조 표시 합니다.
...
디자이너는 **속성 패드**를 통해 위젯 속성을 편집할 수 있도록 지원 합니다. 속성 패드에 나열 된 속성은 디자이너 화면에서 선택 된 위젯에 따라 변경 됩니다. `Button`이전 예제의를 선택 하면 해당 `Button` 위젯의 속성이 표시 됩니다.
...
속성 패드는 비슷한 속성을 함께 그룹화 하는 여러 섹션으로 나뉘어 &ndash; 있으므로 관심 있는 속성을 쉽게 찾을 수 있습니다.

- **위젯** &ndash; 위젯의 기본 속성 (예:,, 등) `id`   `visibility` `text` 위젯의 콘텐츠를 관리 하기 위한 속성은 일반적으로 여기에 배치 됩니다.

- **스타일** &ndash; 위젯의 시각적 모양 (예:,, 등)을 변경 하는 속성입니다 `font` `text color` `background` .
...
일부 속성은 레이아웃 **. axml** 파일 이외의 파일에 정의 된 리소스를 참조할 수 있습니다. 이 형식의 가장 일반적인 사례는 `string` 및 `drawable` 리소스입니다. 그러나 값 및 차원과 같은 다른 리소스에도 참조를 사용할 수 있습니다 `Boolean` .
속성이 리소스 참조를 지 원하는 경우 &hellip; 속성에 대 한 텍스트 항목 옆에 찾아보기 아이콘 (줄임표)이 표시 됩니다.
...
다음 예제에서는의 속성에 대 한 리소스 선택기를 보여 줍니다 `Src` `ImageView` .
...
*부울* 속성은 일반적으로 속성 패드에 확인란으로 표시 됩니다. `Boolean`속성이 리소스 참조를 지 원하는 경우 속성 옆에 작은 확인란이 표시 됩니다. 선택 된 확인란은이 `true` 고 빈 상자는를 의미 `false` 합니다. 또는와 같은 값을 직접 입력할 수도 있습니다 `true` `false` . 입력 위로 마우스를 가져가면 작은 텍스트 필드 아이콘이 표시 됩니다. 값을 수동으로 입력 하려는 경우이를 클릭 하면 됩니다.
...
일부 위젯에는 함께 그룹화 되는 다중 값 속성이 있습니다 (예: `Padding` ). 이러한 속성 값은 확장 가능한 단일 행의 **속성 패드** 에 나열 됩니다. 이러한 속성 중 일부는 아래에 표시 된 속성과 같이 그룹화 된 행에서 직접 편집할 수 있습니다 `Padding` .
...
일부 위젯의 텍스트 속성 (예: `Button` 및)은 `TextView` Design Surface에서 직접 편집할 수 있습니다. 위젯을 두 번 클릭 하면 아래와 같이 편집 모드로 전환 됩니다.
