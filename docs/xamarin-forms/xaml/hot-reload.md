---
title: XAML 핫 재 로드 Xamarin.Forms
...
ms.locfileid: "91563889"
---
# <a name="xaml-hot-reload-for-no-locxamarinforms"></a>XAML 핫 재 로드 Xamarin.Forms
...
## <a name="enable-xaml-hot-reload-for-no-locxamarinforms"></a>XAML 핫 다시 로드 사용 Xamarin.Forms
...
* **Windows** [방법: 여러 개의 시작 프로젝트 설정](/visualstudio/ide/how-to-set-multiple-startup-projects?view=vs-2019)
* **Mac** [여러 시작 프로젝트 설정](/visualstudio/mac/set-startup-projects?view=vsmac-2019)
