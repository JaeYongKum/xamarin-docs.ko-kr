...
![그림자 효과 프로젝트 책임](attached-properties-images/shadow-effect.png)
...
![각 플랫폼의 그림자 효과](attached-properties-images/screenshots.png)
...
- [그림자 효과(샘플)](/samples/xamarin/xamarin-forms-samples/effects-shadoweffectruntimechange)